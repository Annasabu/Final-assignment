...
Original file is located at
    https://colab.research.google.com/drive/1n1My2YuiaeRVJO_boB_Jvf9bgGWyCLKn
...
!pip install yfinance beautifulsoup4 html5lib pandas requests
import yfinance as yf
import pandas as pd
import requests
from bs4 import BeautifulSoup
...
tesla_revenue.dropna(inplace=True)
tesla_revenue = tesla_revenue[tesla_revenue['Revenue'] != ""]
print("Tesla revenue data loaded.")
...
print("GameStop stock data loaded.")
...
print("GameStop revenue data loaded.")
